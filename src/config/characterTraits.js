...
export const TRAIT_CATEGORIES = [
  ...
  // ── Pose ──
  {
    ...
    options: [
      ...
      { id: 'heroic',        label: 'Heroico',         prompt: 'heroic standing pose chest out' },
      { id: 'guarding',      label: 'Guardia',         prompt: 'guarding defensive stance' },
      { id: 'praying',       label: 'Rezando',         prompt: 'praying with clasped hands' },
      { id: 'riding',        label: 'Montando',        prompt: 'riding a creature or mount' },
      { id: 'floating',      label: 'Flotando',        prompt: 'floating magically in air' },
      { id: 'flying',        label: 'Volando',         prompt: 'soaring flying through air' },
      { id: 'falling',       label: 'Cayendo',         prompt: 'falling mid-air' },
      { id: 'sleeping',      label: 'Durmiendo',       prompt: 'sleeping peacefully' },
      { id: 'playing-instrument', label: 'Tocando instrumento', prompt: 'playing a musical instrument' },
      { id: 'reading',       label: 'Leyendo',         prompt: 'reading a book or scroll' },
      { id: 'whispering',    label: 'Susurrando',      prompt: 'whispering secretively' },
      { id: 'sneaking',      label: 'Sigiloso',        prompt: 'sneaking stealthy crouched' },
      { id: 'mourning',      label: 'Duelo',           prompt: 'mourning sorrowful pose' },
      { id: 'celebrating',   label: 'Celebrando',      prompt: 'celebrating triumphant pose' },
      { id: 'commanding',    label: 'Ordenando',       prompt: 'commanding giving orders' },
      { id: 'begging',       label: 'Suplicando',      prompt: 'begging pleading pose' },
      { id: 'threatening',   label: 'Amenazando',      prompt: 'threatening menacing pose' },
      { id: 'victory',       label: 'Victoria',        prompt: 'victory triumphant arms raised' },
      { id: 'defeated',      label: 'Derrotado',       prompt: 'defeated fallen position' },
      { id: 'tied-up',       label: 'Atado',           prompt: 'bound tied up restrained' },
      { id: 'stretching',    label: 'Estirándose',     prompt: 'stretching reaching upward' },
      { id: 'yawning',       label: 'Bostezando',      prompt: 'yawning stretching lazily' },
      { id: 'eating',        label: 'Comiendo',        prompt: 'eating or drinking' },
      { id: 'working',       label: 'Trabajando',      prompt: 'working at a task' },
    ],
  },
